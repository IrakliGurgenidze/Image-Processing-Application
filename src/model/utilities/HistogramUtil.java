...
public class HistogramUtil {
    ...
    private static void drawColors(int[][] channels, Graphics graphics) {
        ...
        //draw green line
        int prevGreen = (int) ((double) channels[1][0] / maxFreq * 255);
        graphics.setColor(Color.GREEN);
        for (int i = 1; i < channels[1].length; i++) {
            int scaledVal = (int) ((double) channels[1][i] / maxFreq * 255);
            graphics.drawLine(i - 1, 255 - prevGreen, i, 255 - scaledVal);
            prevGreen = scaledVal;
        }

        //drw blue line
        int prevBlue = (int) ((double) channels[2][0] / maxFreq * 255);
        graphics.setColor(Color.BLUE);
        for (int i = 1; i < channels[2].length; i++) {
            int scaledVal = (int) ((double) channels[2][i] / maxFreq * 255);
